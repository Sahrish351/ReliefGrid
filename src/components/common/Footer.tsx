...
import { ShieldCheck, Heart, Radio, MapPin, Sparkles, ArrowRight, Lock } from 'lucide-react';
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-navy-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-2.5">
              ...
              <span className="font-heading font-extrabold text-xl text-white tracking-tight">RELIEFGRID</span>
            </div>
            ...
            <div className="text-xs text-navy-400 italic">
              &ldquo;When Every Second Matters, Intelligence Should Move First.&rdquo;
            </div>
          </div>

          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-navy-300">Public &amp; Directory</h4>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-navy-300">Platform &amp; Portals</h4>
            <ul className="space-y-2 text-sm text-navy-200">
              <li><Link to="/login" className="hover:text-white transition-colors flex items-center space-x-1.5"><Lock className="w-3.5 h-3.5 text-emergency-500" /><span>Sign In to Console</span></Link></li>
              <li><Link to="/register" className="hover:text-white transition-colors">Get Started</Link></li>
              <li><Link to="/how-it-works" className="hover:text-white transition-colors">How It Works</Link></li>
              <li><Link to="/ai-technology" className="hover:text-white transition-colors">AI &amp; Agent Architecture</Link></li>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-navy-400 gap-4">
          ...
          <div className="flex items-center space-x-6 text-navy-300">
            ...
            <span>&copy; {new Date().getFullYear()} RELIEFGRID</span>
          </div>
        </div>
